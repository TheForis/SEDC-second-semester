        ...
        private void CreateNewCar()
        {
            while (true)
            {
                try
                {
                    ...
                    Console.Write("Licence plate expiry date: ");
                    var licencePlateExpiryDate = InsertDate();
                    Console.Write("Car model: ");
                    var carModel = Console.ReadLine();
                    
                    _carService.CreateCar(licencePlate,licencePlateExpiryDate,carModel);

                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine($"Successfully created car with model: {carModel}!");
                    Console.ForegroundColor = ConsoleColor.White;
                    break;
                }
                catch (Exception ex)
